                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="panel panel-white">
                                ...
                                <?php else:?>
                                	<form class="form-horizontal" action="<?php echo base_url()?>apanelForms/saveHeading" method="post">
                            	...
                            	<div class="panel-body">
                                   <div class="table-responsive">
                                    <table id="example" class="display table" style="width: 100%; cellspacing: 0;">
                                        ...
                                        <tbody>
                                        	<?php $i = 1;?>
                                        	<?php $res = $this->db->get("heading")->result();?>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                	<a href="<?php echo base_url();?>apanelForms/deleteHeading/<?php echo $row->id;?>">Delete</a>
                                                </td>
                                            </tr>
                                            <?php $i++;?>
                                            <?php endforeach;?>
