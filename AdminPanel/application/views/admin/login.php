                ...
                <div id="main-wrapper">
                    <div class="row">
                        <div class="col-md-3 center">
                            <div class="login-box">
                                <a href="<?php echo base_url()?>apanel/index" class="logo-name text-lg text-center">Sevashram Health & Wellness Care Login</a>
                                ...
                                <p class="text-center m-t-xs text-sm">2017 &copy; Niktech Solutions.</p>
                            </div>
                        </div>
                    </div><!-- Row -->
                </div><!-- Main Wrapper -->
