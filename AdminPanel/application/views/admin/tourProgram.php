                        ...
                        <div class="col-md-12">
                            <div class="panel panel-white">
                            	<div class="panel-heading clearfix">
                                    <h4 class="panel-title">Enter Tour Program Title And About Program</h4>
                                </div>
                                ...
                                <?php else:?>
                                	<form class="form-horizontal" action="<?php echo base_url()?>apanelForms/tourProgram" method="post">
                                        <div class="form-group">
                                            <label for="input-Default" class="col-sm-2 control-label">Subject</label>
                                            <div class="col-sm-10">
                            	...
                            	<div class="panel-body">
                                   <div class="table-responsive">
                                    <table id="example" class="display table" style="width: 100%; cellspacing: 0;">
                                        ...
                                        <tbody>
                                        	<?php $i = 1;?>
                                        	<?php $res = $this->db->get("tour_program")->result();?>
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo $row->program_msg; ?></td>
                                                <td><?php echo $row->date; ?></td>
                                                <td>
                                                	 
                                                	<a href="<?php echo base_url();?>apanelForms/deleteTour/<?php echo $row->sno;?>">Delete</a>
                                                </td>
                                            </tr>
                                            <?php $i++;?>
                                            <?php endforeach;?>
